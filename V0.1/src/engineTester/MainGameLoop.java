...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		GUIText text = new GUIText("TestTest", 3f, font, new Vector2f(-0.41f, 0f), 1f, true);
		//GUIText text1 = new GUIText("y: " + player.getPosition().y, 3f, font, new Vector2f(-0.41f, 0.1f), 1f, true);
		//GUIText text2 = new GUIText("z: " + player.getPosition().z, 3f, font, new Vector2f(-0.41f, 0.2f), 1f, true);
		text.setColour(1, 1, 1);
		//text1.setColour(1, 1, 1);
		...
		//ParticleTexture particleTexture1 = new ParticleTexture(loader.loadTexture("particleStar"), 1);
		ParticleSystem system = new ParticleSystem(particleTexture, 50, 25, 0.3f, 4, 1);
		//ParticleSystem system1 = new ParticleSystem(particleTexture1, 50, 25, 0.3f, 4, 1);
		...
		//system1.setDirection(new Vector3f(0, 1, 0), 0.1f);
		//system1.setLifeError(0.1f);
		//system1.setSpeedError(0.4f);
		//system1.setScaleError(0.8f);
		
		//****************Game Loop Below*********************

		
		while (!Display.isCloseRequested()) {
			Input.checkForInputs(player, terrain);
			camera.move();
			picker.update();
			
			//this is the location that particles are spawned
			system.generateParticles(player.getPosition());
			//system1.generateParticles(player.getPosition());
