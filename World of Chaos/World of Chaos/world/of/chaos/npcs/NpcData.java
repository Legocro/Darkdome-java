...
public class NpcData {
	...
	public static final int[] npcsOnlyMage = { 0123, 0123, 0123 };// done
	public static final int[][] transformNpc = { { 0123, 0123 },
			{ 0123, 0123 }, { 0123, 0123 }};// done
	public static final int[] npcsCantKillYou = { 0123, 0123, 0123, 0123 };// done
	public static final int[] npcCantAttack = { 0123, 0123, 0123 };
	public static final int[] npcDontGiveXp = { 0123, 0123, 0123, 0123 };
